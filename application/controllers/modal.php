...
*/
          //  $page_data['curso_turma'] = $this->db->get_where('cursos')->result_array();
           ...
           // $page_data['curso_turma'] = $this->db->get_where('cursos')->result_array();
        }else if ($param1 == 'editar_bolsa') {
            $page_data['edit_data'] = $this->db->get_where('bolsas', array('bolsas_id' => $param2))->result_array();
            
        }else if ($param1 == 'editar_professor') {
            
            $page_data['edit_data'] = $this->db->get_where('professor', array('professor_id' => $param2))->result_array();
        }
