                        ...
                        <tr>
							...
							<td align="center">
                            	<a data-toggle="modal" href="#modal-form" onclick="modal('edit_notice',<?php echo $row['notice_id'];?>)" class="btn btn-gray btn-small">
                                		<i class="icon-wrench"></i> <?php echo 'edit';?>
                                </a>
                            	<a data-toggle="modal" href="#modal-delete" onclick="modal_delete('<?php echo base_url();?>index.php?admin/noticeboard/delete/<?php echo $row['notice_id'];?>')" class="btn btn-red btn-small">
                                		<i class="icon-trash"></i> <?php echo 'delete';?>
                                </a>
        					</td>
                        </tr>
                        <?php endforeach;?>
                ...
                <div class="box-content">
                	<?php echo form_open('admin/noticeboard/create' , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                                ...
                                <div class="controls">
                                    <div class="box closable-chat-box">
                                        <div class="box-content padded">
                                                ...
                                                <textarea name="notice" id="ttt" rows="5" placeholder="<?php echo 'add_notice';?>"></textarea>
                                                </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-blue"><?php echo 'add_noticeboard';?></button>
                        </div>
                    </form>                
                </div>                
			</div>
