...
<div class="tab-pane box active" id="edit" style="padding: 5px">
    <div class="box-content">
        <?php foreach ($edit_data as $row): ?>
            <?php echo form_open('financeiro/mensalidades/cancela/' . $row['mensalidades_id'], array('class' => 'form-horizontal validatable', 'target' => '_top', 'enctype' => 'multipart/form-data')); ?>
            <div class="padded">
            ...
            <div class="form-actions">
                <button type="submit" class="btn btn-red"><?php echo get_phrase('cancela_pagamento'); ?></button>
            </div>
            </form>
        <?php endforeach; ?>
    </div>
