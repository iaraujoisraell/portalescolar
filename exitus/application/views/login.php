...
<html>
    ...
    <div style="height: 40px;
        ...
        <h3 style="margin-top: 0px; margin-left: 10px; color: #006dcc;"><a style="color: #006dcc;" href="http://localhost/portalescolar/"> ÊXITUS - Sistema Escolar Online</a></h3>
            </div>
	...
	<body>
            ...
            <div class="container">
                <div class="span4 offset4">
                    <div class="padded">
                        <center>
                            <img src="<?php echo base_url();?>uploads/logohome.png" style="max-height:100px;margin:20px 0px;" />
                        </center>
                             ...
                             <form method="post" action="<?php echo base_url(); ?>index.php?login/valida_login/" class="form-horizontal validatable" enctype="multipart/form-data">
                                 ...
                                 <br><br>
                                    <div class="row-fluid">
                                        ...
                                        <div class="span6">
                                            <a  data-toggle="modal" href="#modal-simple"  class="btn btn-black btn-block" >
                                                Esqueci Minha Senha
                                            </a>
                                        </div>
                                    </div>
