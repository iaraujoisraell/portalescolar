    ...
    <div class="box-header">
        ...
        <ul class="nav nav-tabs nav-tabs-left">
            <li class="active">
             ...
             <font style="color: #ffffff; font-size: 16px; margin-top: 45px; margin-left: 20px;"> <?php echo 'PROTOCOLO DE PROVA'; ?></font>
...
<script>
    ...
    function buscar_paginacao() {
        ...
        if ((aluno) || (curso != '0') || (turma != '0')) {
            var url = 'index.php?educacional/carrega_table_paginacao_protocolo/' + curso + '/' + turma + '/' + aluno;  //caminho do arquivo php que irá buscar as cidades no BD
            $.get(url, function (dataReturn) {
